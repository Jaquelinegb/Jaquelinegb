"""
Estrutura de seleção if: exemplo 2
Descrição:
#Faça um programa que pergunte a idade de uma pessoa
#Se a idade for maior do que 18 anos, o programa imprime na tela
#"Oi! Voce eh um adulto."
#Se a pessoa tiver menos de 18 anos, imprima
#"Oi, voce eh menor de idade."
